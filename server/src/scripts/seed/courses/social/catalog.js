...
**Algoritmo**: sistema automático que decide qué contenido mostrar según lo que el menor ve, repite, comenta o deja pasar.

**Feed**: pantalla donde aparecen publicaciones o videos uno tras otro.

**For You Page**: pantalla principal de TikTok donde aparecen videos recomendados por la plataforma, incluso de cuentas que el menor no sigue.

**Servidor de Discord**: espacio o comunidad dentro de Discord, normalmente organizado por temas, grupos o intereses.

**Canal**: sección dentro de un servidor de Discord donde se habla de un tema específico por texto, voz o video.

**Mensaje directo o DM**: conversación privada entre usuarios dentro de una app.

**Historia**: publicación temporal, común en Instagram, que suele desaparecer después de un tiempo.
...
El grooming es un proceso de manipulación en el que una persona gana poco a poco la confianza de un menor para después presionarlo, aislarlo, pedirle secretos, mover la conversación a espacios privados o solicitarle fotos, videos o información personal.
...
**Influencer**: persona que crea contenido y puede influir en gustos, compras o formas de pensar de sus seguidores.

**Reel**: video corto de Instagram, diseñado para verse rápido y pasar al siguiente.

**Paid partnership**: etiqueta de Instagram que indica que hay una colaboración pagada o una relación comercial con una marca.

**Promotional content**: etiqueta o aviso de TikTok para señalar contenido con intención comercial.

**Contenido patrocinado**: publicación, video o historia donde una marca paga, regala algo o da un beneficio para aparecer o ser recomendada.
...
**Coins**: monedas digitales de TikTok que se compran con dinero real.

**Gifts**: regalos digitales que un usuario puede enviar a un creador; aunque parezcan símbolos, pueden implicar gasto real.

**Stars**: forma de apoyo digital en Instagram que puede relacionarse con pagos dentro de la plataforma.

**Nitro**: suscripción de pago de Discord que ofrece beneficios como mejoras de perfil, emojis o funciones extra.

**Gifting**: regalar una suscripción o beneficio digital a otra persona.
...
**Family Pairing**: herramienta de TikTok para vincular la cuenta del adulto con la del adolescente y administrar límites o ajustes de seguridad.
...
**Contenido sensible**: material que puede ser fuerte, sexual, violento, perturbador o no adecuado para la edad del menor.
...
Cuando el adulto entiende la aplicación, conversa con frecuencia, ajusta reglas con sentido y usa los controles como apoyo, la supervisión deja de sentirse como persecución y empieza a funcionar como acompañamiento real.`,
    ...
    const module1QuizQuestions = [
        {
            text: 'Relaciona cada plataforma con la descripción que mejor la define según el módulo.',
            type: 'drag_drop',
            metadata: {
                pairs: [
                    { key: 'TikTok', value: 'Flujo de videos cortos donde el algoritmo decide qué aparece, no solo a quién sigues' },
                    { key: 'Discord', value: 'Plataforma organizada en servidores y canales para hablar, jugar y convivir en grupo' },
                    { key: 'Instagram', value: 'Combina perfil personal, publicaciones, historias y mensajes en un mismo espacio' },
                    { key: 'Algoritmo', value: 'Sistema que aprende qué llama tu atención y muestra más de eso automáticamente' },
                    { key: 'Servidor (Discord)', value: 'Espacio dentro de Discord donde un grupo de personas se organiza por canales y temas' },
                ],
                correctAnswer: {
                    TikTok: 'Flujo de videos cortos donde el algoritmo decide qué aparece, no solo a quién sigues',
                    Discord: 'Plataforma organizada en servidores y canales para hablar, jugar y convivir en grupo',
                    Instagram: 'Combina perfil personal, publicaciones, historias y mensajes en un mismo espacio',
                    Algoritmo: 'Sistema que aprende qué llama tu atención y muestra más de eso automáticamente',
                    'Servidor (Discord)': 'Espacio dentro de Discord donde un grupo de personas se organiza por canales y temas',
                },
            },
            explanation: 'TikTok depende del algoritmo para mostrar contenido. Discord gira en torno a la conversación en servidores. Instagram mezcla imagen personal, publicaciones y mensajería.',
            points: 12,
        },
        {
            ...
            type: 'fill_blanks',
            metadata: {
                sentence: 'En TikTok, gran parte del contenido que aparece lo decide el [blank1], no solo las cuentas que sigues. En Discord, lo más importante es la [blank2] con otras personas dentro de servidores. En Instagram, la [blank3] personal y la búsqueda de aprobación social tienen mucho peso. Para supervisar bien, conviene entender la [blank4] de funcionamiento de cada plataforma, porque no todas [blank5] igual.',
                bank: ['algoritmo', 'conversación', 'imagen', 'lógica', 'funcionan'],
                correctAnswer: {
                    blank1: 'algoritmo',
                    blank2: 'conversación',
                    blank3: 'imagen',
            ...
            explanation: 'TikTok = algoritmo. Discord = conversación. Instagram = imagen personal. Cada plataforma tiene su propia lógica de supervisión.',
            points: 12,
        },
        {
            text: 'Relaciona cada plataforma con la característica que la distingue claramente de las otras dos.',
            type: 'match_columns',
            metadata: {
                left: ['TikTok', 'Discord', 'Instagram'],
                right: [
                    'La pantalla de inicio muestra principalmente videos de cuentas que el menor no sigue (For You Page)',
                    'El menor puede unirse a grupos privados llamados servidores con canales de texto y voz',
                    'El menor publica fotos y Reels que quedan en la cuadrícula permanente de su perfil',
                    'La herramienta oficial de protección se llama Sincronización familiar',
                    'La herramienta oficial de protección se llama Family Center',
                    'La herramienta oficial de protección se llama Teen Accounts',
                ],
                correctAnswer: {
                    TikTok: [
                        'La pantalla de inicio muestra principalmente videos de cuentas que el menor no sigue (For You Page)',
            ...
            explanation: 'Sincronización familiar es la herramienta de TikTok. Family Center es de Discord. Teen Accounts es de Instagram. Cada plataforma tiene su propio sistema de control parental.',
            points: 12,
        },
        {
            text: 'Ordena cómo una plataforma puede reforzar el hábito de volver en un menor.',
            type: 'order_sequence',
            metadata: {
                items: [
                    'El menor abre la app para ver, hablar o publicar.',
                    'Recibe contenido o interacción que le resulta atractiva.',
                    'La plataforma detecta ese interés y refuerza la experiencia.',
                    'Aparece más contenido o más oportunidades de interacción similares.',
                    'Al menor le cuesta más detenerse o cerrar la aplicación.',
                ],
                correctAnswer: [
                    'El menor abre la app para ver, hablar o publicar.',
                    'Recibe contenido o interacción que le resulta atractiva.',
            ...
            explanation: 'El atractivo de las plataformas no está solo en la primera visita, sino en cómo la experiencia se refuerza a sí misma para invitar a volver.',
            points: 8,
        },
        {
            text: 'Selecciona las tres razones principales que el módulo menciona por las que TikTok, Discord e Instagram atraen especialmente a niños y adolescentes.',
            type: 'multiple_selection',
            options: [
                { text: 'Ofrecen recompensa rápida (likes, respuestas, nuevo contenido)', isCorrect: true },
                { text: 'Generan sensación de pertenencia a un grupo o comunidad', isCorrect: true },
                { text: 'Permiten explorar la identidad y buscar reconocimiento', isCorrect: true },
                { text: 'Bloquean automáticamente el contenido inapropiado para menores', isCorrect: false },
                { text: 'Limitan el tiempo de uso sin intervención del padre', isCorrect: false },
            ],
            explanation: 'Recompensa rápida, pertenencia y exploración de identidad son los tres motores principales del atractivo que el módulo identifica. Las plataformas NO bloquean contenido automáticamente ni limitan el tiempo por sí solas.',
            points: 10,
        },
        {
            text: 'Elige la opción correcta para completar cada oración sobre cómo supervisar cada plataforma.',
            type: 'drop_down',
            metadata: {
                sentence: 'En TikTok lo más importante es vigilar [blank1] y el tiempo de uso. En Discord lo más importante es saber [blank2] y en qué comunidades participa. En Instagram lo más importante es revisar la [blank3] del perfil y la exposición de imagen personal. La herramienta de TikTok para padres se llama [blank4]. La herramienta de Instagram para menores se llama [blank5].',
                options: {
                    blank1: ['el algoritmo y lo que aparece en el feed', 'el número de seguidores', 'los filtros de imagen'],
                    blank2: ['con quién habla el menor', 'cuántos videos ha visto', 'qué filtros usa'],
                    blank3: ['privacidad', 'velocidad de carga', 'calidad de foto'],
                    blank4: ['Sincronización familiar', 'Family Center', 'Teen Accounts'],
                    blank5: ['Teen Accounts', 'Sincronización familiar', 'Family Center'],
                },
                correctAnswer: {
                    blank1: 'el algoritmo y lo que aparece en el feed',
                    blank2: 'con quién habla el menor',
                    blank3: 'privacidad',
                    blank4: 'Sincronización familiar',
                    blank5: 'Teen Accounts',
                },
            },
            explanation: 'Cada plataforma requiere una supervisión distinta: TikTok → algoritmo y tiempo. Discord → conversaciones y comunidades. Instagram → privacidad e imagen. Y cada una tiene su herramienta oficial propia.',
            points: 10,
        },
        {
            text: 'Asigna cada elemento a la plataforma a la que pertenece según el módulo.',
            type: 'categorize',
            metadata: {
                items: [
                    'El contenido principal son videos breves en el feed',
                    'El menor puede entrar a servidores de temas como videojuegos o anime',
                    'Las publicaciones de fotos y Reels quedan en la cuadrícula permanente del perfil',
                    'Los videos del For You Page se reproducen aunque el menor no siga a ninguno de los creadores',
                    'Family Center es su herramienta oficial para padres',
                    'La sección Explorar muestra publicaciones recomendadas de cuentas que el menor no sigue',
                ],
            ...
            explanation: 'Videos breves y feed sin seguidos = TikTok. Servidores y Family Center = Discord. Historias de 24 horas y perfil con seguidores = Instagram.',
            points: 15,
        },
        {
            text: 'Caso: Un padre revisa el teléfono de su hijo y nota que usa TikTok, Discord e Instagram. Le dice: "Todas son lo mismo, así que voy a poner la misma regla: solo 30 minutos al día en total". ¿Qué problema tiene ese enfoque según el módulo?',
            type: 'case_study',
            options: [
                { text: 'Ignorar que cada plataforma tiene riesgos distintos: en TikTok el riesgo principal está en el algoritmo y el tiempo, en Discord en con quién habla y en qué comunidades entra, y en Instagram en la privacidad y la comparación social.', isCorrect: true },
                { text: 'Poner límite de tiempo es un error porque los menores deben poder usar las apps sin restricciones.', isCorrect: false },
                { text: 'El error es que 30 minutos es demasiado poco; debería ser al menos 2 horas por plataforma.', isCorrect: false },
                { text: 'No hay ningún problema; el tiempo es la única variable que importa en todas las plataformas.', isCorrect: false },
            ],
            explanation: 'El módulo enseña que poner la misma regla a todo no funciona porque cada plataforma tiene una lógica y riesgos distintos. El tiempo importa, pero no es lo único que hay que supervisar.',
            points: 15,
        },
    ];
    ...
    const module2QuizQuestions = [
        {
            text: 'Relaciona cada concepto del módulo con su definición correcta.',
            type: 'drag_drop',
            metadata: {
                pairs: [
                    { key: 'Huella digital', value: 'Rastro acumulado de publicaciones, reacciones, contactos y actividad que el menor deja en internet' },
                    { key: 'Datos de perfil', value: 'Foto, nombre de usuario, apodo o biografía que puede identificar al menor aunque no publique nada más' },
                    { key: 'Permisos del dispositivo', value: 'Accesos que una app tiene a la cámara, micrófono, contactos, fotos o ubicación del teléfono' },
                    { key: 'Cuenta privada', value: 'Configuración que limita quién puede ver el contenido, pero no borra la huella ni protege todo' },
                    { key: 'Circulación fuera de control', value: 'Lo que ocurre cuando alguien guarda o reenvía contenido que el menor creyó que solo verían sus contactos' },
                ],
                correctAnswer: {
                    'Huella digital': 'Rastro acumulado de publicaciones, reacciones, contactos y actividad que el menor deja en internet',
                    'Datos de perfil': 'Foto, nombre de usuario, apodo o biografía que puede identificar al menor aunque no publique nada más',
                    'Permisos del dispositivo': 'Accesos que una app tiene a la cámara, micrófono, contactos, fotos o ubicación del teléfono',
                    'Cuenta privada': 'Configuración que limita quién puede ver el contenido, pero no borra la huella ni protege todo',
                    'Circulación fuera de control': 'Lo que ocurre cuando alguien guarda o reenvía contenido que el menor creyó que solo verían sus contactos',
                },
            },
            explanation: 'La huella digital se construye de muchas formas. Una cuenta privada ayuda, pero no basta. Los permisos del dispositivo dan acceso a información más allá de las publicaciones.',
            points: 12,
        },
        {
            text: 'Completa cada oración con la palabra correcta del banco.',
            type: 'fill_blanks',
            metadata: {
                sentence: 'Un menor comparte datos no solo cuando publica, sino también a través de su [blank1], sus permisos del [blank2] y su actividad dentro de la app. Aunque la cuenta sea [blank3], la huella digital no desaparece. La [blank4] es un dato especialmente sensible porque puede revelar dónde está. Si alguien reenvía un mensaje, el contenido puede circular fuera de [blank5].',
                bank: ['perfil', 'dispositivo', 'privada', 'ubicación', 'control'],
                correctAnswer: {
                    blank1: 'perfil',
                    blank2: 'dispositivo',
                    blank3: 'privada',
            ...
            explanation: 'Perfil, dispositivo, cuenta privada, ubicación y pérdida de control son los cinco conceptos clave del módulo 2.',
            points: 12,
        },
        {
            text: 'Clasifica cada ejemplo según el tipo de exposición que representa.',
            type: 'match_columns',
            metadata: {
                left: ['Datos de perfil', 'Actividad dentro de la app', 'Ubicación y contexto'],
                right: [
                    'El nombre de usuario incluye el nombre real y el año de nacimiento',
                    'La biografía del perfil menciona el nombre de la escuela',
                    'El menor participa en un servidor de Discord sobre un tema sensible',
                    'La app registra a qué horas está conectado el menor y con quién habla',
                    'El permiso de ubicación está activado en TikTok',
                    'Una historia muestra el uniforme escolar frente al edificio de la escuela',
                ],
                correctAnswer: {
                    'Datos de perfil': [
                        'El nombre de usuario incluye el nombre real y el año de nacimiento',
            ...
            explanation: 'Los datos de perfil identifican al menor. La actividad revela hábitos y vínculos. La ubicación y contexto muestran dónde está. Los tres tipos son distintos.',
            points: 12,
        },
        {
            text: 'Ordena cómo una publicación puede convertirse en parte permanente de la huella digital.',
            type: 'order_sequence',
            metadata: {
                items: [
                    'El menor publica, comenta o reacciona a algo en línea.',
                    'La información queda visible para otras personas o para la plataforma.',
                    'Alguien puede guardarla, capturarla o reenviarla.',
                    'El contenido circula más allá del control del menor.',
            ...
            explanation: 'Una vez publicado, el menor pierde el control. Por eso conviene pensar antes de publicar o reaccionar.',
            points: 8,
        },
        {
            text: 'Selecciona las tres acciones que SÍ contribuyen a construir la huella digital de un menor.',
            type: 'multiple_selection',
            options: [
                { text: 'Publicar una foto que muestra su uniforme y el nombre de la escuela', isCorrect: true },
                { text: 'Comentar de forma impulsiva en una publicación pública', isCorrect: true },
                { text: 'Unirse a un servidor de Discord con personas que no conoce en persona', isCorrect: true },
                { text: 'Revisar junto a su padre la configuración de privacidad de la cuenta', isCorrect: false },
                { text: 'Desactivar el permiso de ubicación en todas las apps de redes sociales', isCorrect: false },
            ],
            explanation: 'Publicar datos identificables, comentar en público y unirse a comunidades con desconocidos SÍ construyen huella digital. Revisar privacidad y desactivar ubicación son acciones preventivas que la REDUCEN.',
            points: 10,
        },
        {
            text: 'Elige la opción correcta para completar cada oración sobre privacidad y huella digital.',
            type: 'drop_down',
            metadata: {
                sentence: 'Una cuenta [blank1] ayuda a limitar quién ve el contenido, pero no borra la huella digital. Los permisos de [blank2], micrófono o contactos dan a la app acceso a información que va más allá de las publicaciones. La ubicación es un dato sensible porque puede revelar [blank3]. Si alguien hace una [blank4] de pantalla, el contenido puede circular aunque el menor lo haya borrado. Para proteger bien hay que revisar el perfil, los permisos y la [blank5] de la cuenta.',
                options: {
                    blank1: ['privada', 'nueva', 'anónima'],
                    blank2: ['cámara', 'teclado', 'pantalla'],
                    blank3: ['dónde está o cómo se mueve el menor', 'qué música escucha', 'cuántos años tiene la app'],
                    blank4: ['captura', 'pausa', 'traducción'],
                    blank5: ['visibilidad', 'velocidad', 'estética'],
                },
                correctAnswer: {
                    blank1: 'privada',
                    blank2: 'cámara',
                    blank3: 'dónde está o cómo se mueve el menor',
                    blank4: 'captura',
                    blank5: 'visibilidad',
                },
            },
            explanation: 'Cuenta privada, permisos de cámara, datos de ubicación, capturas y visibilidad del perfil son los cinco puntos clave del módulo 2.',
            points: 10,
        },
        {
            text: 'Asigna cada ejemplo a la categoría correcta según lo que representa.',
            type: 'categorize',
            metadata: {
                items: [
                    'Nombre de usuario con nombre real y año de nacimiento',
                    'Foto de perfil que muestra el uniforme escolar',
                    'Alguien reenvía un mensaje privado a otras personas',
                    'Un tercero hace captura de una historia que ya desapareció',
                    'El padre revisa con el menor los permisos activos de las apps',
                    'La cuenta pasa de pública a privada y se revisa quién puede enviar mensajes',
                ],
                categories: ['Dato que identifica al menor', 'Contenido que escapa al control', 'Acción para proteger la privacidad'],
                correctAnswer: {
                    'Dato que identifica al menor': [
                        'Nombre de usuario con nombre real y año de nacimiento',
                        'Foto de perfil que muestra el uniforme escolar',
                    ],
                    'Contenido que escapa al control': [
                        'Alguien reenvía un mensaje privado a otras personas',
                        'Un tercero hace captura de una historia que ya desapareció',
                    ],
                    'Acción para proteger la privacidad': [
                        'El padre revisa con el menor los permisos activos de las apps',
                        'La cuenta pasa de pública a privada y se revisa quién puede enviar mensajes',
                    ],
                },
            },
            explanation: 'Los datos identificadores exponen al menor. El contenido que circula amplía la huella. Las acciones preventivas la reducen. El módulo trabaja los tres planos.',
            points: 15,
        },
        {
            text: 'Caso: Una madre descubre que su hija de 12 años tiene Instagram con su nombre real, una foto del uniforme escolar y el perfil en público. La niña dice: "No pasa nada, no le digo a nadie dónde vivo". ¿Qué le falta considerar según el módulo?',
            type: 'case_study',
            options: [
                { text: 'Que la foto y el nombre de usuario ya identifican a la menor, que el perfil público permite que cualquiera la contacte, y que el uniforme puede revelar la escuela sin necesidad de escribirlo.', isCorrect: true },
                { text: 'Nada, porque mientras no comparta dirección ni teléfono no hay riesgo real de exposición.', isCorrect: false },
                { text: 'Solo hay que preocuparse si sube fotos con su familia; los demás datos no importan.', isCorrect: false },
                { text: 'El único riesgo es recibir mensajes directos; si los ignora, no hay consecuencias.', isCorrect: false },
            ],
            explanation: 'No hace falta escribir la dirección para quedar expuesta. El uniforme, el nombre real y el perfil público ya revelan información sensible y permiten que cualquier persona identifique y contacte al menor.',
            points: 15,
        },
    ];
    ...
    const module3QuizQuestions = [
        {
            ...
            metadata: {
                pairs: [
                    { key: 'Ciberacoso', value: 'Daño repetido en línea mediante humillación, exclusión, rumores o mensajes hirientes hacia el menor' },
                    { key: 'Humillación pública', value: 'Ataque o exposición del menor ante muchas personas dentro de una plataforma' },
                    { key: 'Comparación social', value: 'Medirse constantemente con otros perfiles, cuerpos o niveles de popularidad hasta sentirse inferior' },
                    { key: 'Validación digital', value: 'Ligar el propio valor personal a likes, vistas, seguidores o aprobación de otros en línea' },
                    { key: 'Guardar evidencia', value: 'Conservar capturas de pantalla del acoso para poder reportar, bloquear o pedir ayuda con pruebas' },
                ],
                correctAnswer: {
                    'Ciberacoso': 'Daño repetido en línea mediante humillación, exclusión, rumores o mensajes hirientes hacia el menor',
                    'Humillación pública': 'Ataque o exposición del menor ante muchas personas dentro de una plataforma',
                    'Comparación social': 'Medirse constantemente con otros perfiles, cuerpos o niveles de popularidad hasta sentirse inferior',
                    'Validación digital': 'Ligar el propio valor personal a likes, vistas, seguidores o aprobación de otros en línea',
                    'Guardar evidencia': 'Conservar capturas de pantalla del acoso para poder reportar, bloquear o pedir ayuda con pruebas',
                },
            },
            explanation: 'El ciberacoso implica daño repetido. La humillación pública ocurre frente a otros. La comparación social y la validación digital dañan la autoestima de forma más silenciosa. Guardar evidencia es el primer paso práctico ante el acoso.',
            points: 12,
        },
        {
            text: 'Completa cada oración con la palabra correcta del banco.',
            type: 'fill_blanks',
            metadata: {
                sentence: 'En TikTok el ciberacoso puede sentirse muy [blank1] porque los comentarios y ataques pueden ser vistos por muchas personas. En Discord el daño suele aparecer como hostigamiento dentro de chats o [blank2]. En Instagram la presión se mezcla con la [blank3] personal y la comparación social. Ante una situación de acoso, lo primero es escuchar sin [blank4] y guardar [blank5] antes de bloquear.',
                bank: ['visible', 'servidores', 'imagen', 'culpar', 'evidencia'],
                correctAnswer: {
                    blank1: 'visible',
                    blank2: 'servidores',
                    blank3: 'imagen',
            ...
            explanation: 'TikTok = acoso visible. Discord = servidores y chats. Instagram = imagen personal. Ante el acoso: escuchar sin culpar y guardar evidencia antes de actuar.',
            points: 12,
        },
        {
            text: 'Clasifica cada situación según la plataforma donde ocurre según el módulo.',
            type: 'match_columns',
            metadata: {
                left: ['TikTok', 'Discord', 'Instagram'],
                right: [
                    'El menor borra un video porque recibió ataques masivos en los comentarios',
                    'Un grupo de personas en un servidor se organiza para atacar o excluir al menor',
                    'Alguien crea un perfil falso con la foto del menor para enviar solicitudes de seguimiento a sus contactos',
                    'El menor desactiva los comentarios de sus videos porque recibió críticas masivas en el For You Page',
                    'El menor abandona un servidor de golpe después de ser humillado en un canal',
                    'El menor se compara con cuerpos editados de otras cuentas y se siente inferior',
                ],
                correctAnswer: {
                    TikTok: [
                        'El menor borra un video porque recibió ataques masivos en los comentarios',
            ...
            explanation: 'En TikTok el daño suele ser visible y público. En Discord ocurre dentro de servidores y grupos. En Instagram se mezcla con imagen personal, cuentas falsas y comparación social.',
            points: 12,
        },
        {
            text: 'Ordena la respuesta correcta cuando un menor cuenta que lo están acosando en línea.',
            type: 'order_sequence',
            metadata: {
                items: [
                    'Escuchar con calma y sin culpar al menor.',
                    'Guardar capturas o pruebas de lo que ocurrió.',
                    'Bloquear o reportar al agresor en la plataforma.',
                    'Revisar privacidad y configuración para frenar nuevas agresiones.',
                    'Buscar apoyo externo si el daño continúa o afecta su bienestar.',
                ],
                correctAnswer: [
                    'Escuchar con calma y sin culpar al menor.',
                    'Guardar capturas o pruebas de lo que ocurrió.',
            ...
            explanation: 'El módulo insiste en no empezar castigando ni quitando el dispositivo. Primero escuchar, luego documentar, luego actuar en la plataforma y finalmente buscar apoyo si es necesario.',
            points: 8,
        },
        {
            text: 'Selecciona las tres señales que el módulo identifica como posible indicador de ciberacoso o presión social.',
            type: 'multiple_selection',
            options: [
                { text: 'Se pone triste o irritable justo después de revisar la app', isCorrect: true },
                { text: 'Borra publicaciones porque recibió pocas reacciones o comentarios negativos', isCorrect: true },
                { text: 'Abandona un grupo de Discord de repente sin dar explicaciones', isCorrect: true },
                { text: 'Comparte con su padre lo que pasa en sus chats y le enseña memes', isCorrect: false },
                { text: 'Usa la app para hacer una tarea escolar sobre un tema de clase', isCorrect: false },
            ],
            explanation: 'Tristeza después de usar la app, borrar publicaciones por vergüenza y abandonar grupos de golpe son señales de alerta reales. Compartir cosas con el padre y usar la app para tareas escolares son conductas saludables, no señales de problema.',
            points: 10,
        },
        {
            text: 'Elige la opción correcta para completar cada oración sobre ciberacoso y presión social.',
            type: 'drop_down',
            metadata: {
                sentence: 'El ciberacoso no siempre llega como un [blank1] directo; también puede aparecer como exclusión o rumores repetidos. En Discord la presión puede sentirse como la obligación de estar siempre [blank2] en los grupos. En Instagram y TikTok pesan mucho las métricas y la [blank3] con otros perfiles. Cuando el malestar digital afecta el sueño o el ánimo del menor, ya está afectando su [blank4]. La primera reacción del padre debe ser [blank5] sin culpar.',
                options: {
                    blank1: ['insulto', 'examen', 'juego'],
                    blank2: ['disponible', 'disfrazado', 'en silencio'],
                    blank3: ['comparación', 'velocidad', 'ortografía'],
                    blank4: ['bienestar', 'teclado', 'cargador'],
                    blank5: ['escuchar', 'gritar', 'ignorar'],
                },
                correctAnswer: {
                    blank1: 'insulto',
                    blank2: 'disponible',
            ...
            explanation: 'Ciberacoso sin insulto, disponibilidad constante en Discord, comparación en redes, bienestar afectado y escuchar primero son las cinco ideas centrales del módulo.',
            points: 10,
        },
        {
            text: 'Asigna cada ejemplo a la categoría correcta.',
            type: 'categorize',
            metadata: {
                items: [
                    'Comentarios hirientes repetidos en videos de TikTok',
                    'Exclusión y burlas coordinadas dentro de un servidor de Discord',
                    'Cuentas falsas en Instagram creadas para atacar al menor',
                    'Compararse con cuerpos editados en Instagram y sentirse inferior',
                    'Medir el propio valor según el número de likes de cada publicación',
                    'Guardar capturas antes de bloquear al agresor',
                    'Escuchar al menor sin amenazar con quitarle el dispositivo',
                    'Bloquear y reportar al agresor en la plataforma correspondiente',
                ],
                categories: ['Ciberacoso', 'Presión social y autoestima', 'Respuesta del padre'],
                correctAnswer: {
                    'Ciberacoso': [
                        'Comentarios hirientes repetidos en videos de TikTok',
                        'Exclusión y burlas coordinadas dentro de un servidor de Discord',
            ...
            explanation: 'El módulo trabaja tres planos: el daño directo del ciberacoso, el daño silencioso de la comparación y la autoestima, y las respuestas concretas que puede tomar el padre.',
            points: 15,
        },
        {
            text: 'Caso: Una adolescente borra sus videos de TikTok cuando reciben pocos likes, se compara con cuerpos de otras cuentas de Instagram y se angustia si no contesta rápido en un grupo de Discord. Su padre dice: "Solo está exagerando, no le está pasando nada grave". ¿Qué le falta ver según el módulo?',
            type: 'case_study',
            options: [
                { text: 'Que borrar videos por falta de likes, compararse con otros perfiles y sentir presión por estar disponible son señales reales de daño emocional y presión social, aunque no haya un insulto explícito.', isCorrect: true },
                { text: 'Nada, porque mientras no haya amenazas escritas no existe un problema real de ciberacoso.', isCorrect: false },
                { text: 'Que debe quitarle el teléfono de inmediato para resolver el problema.', isCorrect: false },
                { text: 'Que solo hay que preocuparse si el daño ocurre en una sola plataforma, no en varias a la vez.', isCorrect: false },
            ],
            explanation: 'El módulo enseña que el daño emocional puede aparecer sin insulto directo: como comparación, necesidad de aprobación o miedo a no encajar. Estos son problemas reales que merecen observación, conversación y apoyo.',
            points: 15,
        },
    ];
    ...
    const module4QuizQuestions = [
        {
            ...
            metadata: {
                pairs: [
                    { key: 'Grooming', value: 'Proceso en el que alguien gana la confianza del menor para luego introducir presión, secretos o peticiones incómodas' },
                    { key: 'Contacto insistente', value: 'Acercamiento repetido de una persona que busca mantener conversación o atención del menor' },
                    { key: 'Secreto en línea', value: 'Petición de no contar una conversación a ningún adulto de confianza' },
                    { key: 'Mover la conversación', value: 'Intento de llevar el contacto a otra app o espacio más privado fuera de la plataforma original' },
                    { key: 'Prueba de confianza', value: 'Petición para que el menor demuestre lealtad haciendo algo incómodo o enviando algo privado' },
                ],
                correctAnswer: {
                    'Grooming': 'Proceso en el que alguien gana la confianza del menor para luego introducir presión, secretos o peticiones incómodas',
                    'Contacto insistente': 'Acercamiento repetido de una persona que busca mantener conversación o atención del menor',
                    'Secreto en línea': 'Petición de no contar una conversación a ningún adulto de confianza',
                    'Mover la conversación': 'Intento de llevar el contacto a otra app o espacio más privado fuera de la plataforma original',
                    'Prueba de confianza': 'Petición para que el menor demuestre lealtad haciendo algo incómodo o enviando algo privado',
                },
            },
            explanation: 'El módulo distingue entre el contacto inicial, la construcción de confianza y las peticiones que hacen que la interacción se vuelva manipuladora y peligrosa.',
            points: 12,
        },
        {
            text: 'Completa cada oración con la palabra correcta del banco.',
            type: 'fill_blanks',
            metadata: {
                sentence: 'En TikTok el contacto de riesgo puede empezar por [blank1] insistentes de personas desconocidas. En Instagram puede aparecer por solicitudes de [blank2] o atención de cuentas que generan confianza muy rápido. En Discord el riesgo se concentra en [blank3] abiertos y mensajes directos. El grooming no empieza con amenazas; muchas veces empieza con [blank4] y cercanía rápida. Una señal importante es que alguien pida guardar la conversación en [blank5].',
                bank: ['comentarios', 'mensaje', 'servidores', 'halagos', 'secreto'],
                correctAnswer: {
                    blank1: 'comentarios',
                    blank2: 'mensaje',
                    blank3: 'servidores',
            ...
            explanation: 'TikTok = comentarios insistentes. Instagram = solicitudes de mensaje. Discord = servidores abiertos. El grooming empieza con halagos, no con amenazas. El secreto es la primera señal seria.',
            points: 12,
        },
        {
            text: 'Clasifica cada situación según la plataforma donde el módulo la identificó.',
            type: 'match_columns',
            metadata: {
                left: ['TikTok', 'Discord', 'Instagram'],
                right: [
                    'Un desconocido comenta repetidamente videos del For You Page del menor e intenta abrir un chat privado',
                    'TikTok limita la mensajería directa en menores de 16 años para reducir este tipo de contacto',
                    'Una persona de un servidor abierto le pide hablar a solas por mensajes directos',
                    'El menor entra a comunidades con desconocidos y alguien intenta aislarlo del grupo',
                    'Una cuenta desconocida responde sus publicaciones y envía mensajes a través de la bandeja de Direct del menor',
                    'Instagram refuerza la protección de mensajes directos para cuentas de adolescentes',
                ],
                correctAnswer: {
                    TikTok: [
                        'Un desconocido comenta repetidamente videos del For You Page del menor e intenta abrir un chat privado',
            ...
            explanation: 'Cada plataforma tiene una forma diferente de exponer al menor: TikTok desde comentarios públicos, Discord desde servidores y mensajes directos, Instagram desde historias y solicitudes.',
            points: 12,
        },
        {
            text: 'Ordena cómo evoluciona una interacción que se vuelve manipuladora según el módulo.',
            type: 'order_sequence',
            metadata: {
                items: [
                    'Una persona inicia contacto de forma amable o insistente.',
                    'Genera confianza con atención, halagos o cercanía rápida.',
                    'Intenta llevar la conversación a otra app o espacio más privado.',
                    'Empieza a pedir secretos, fotos o pruebas de confianza.',
                    'El menor se siente presionado, confundido o aislado de sus adultos.',
                ],
                correctAnswer: [
                    'Una persona inicia contacto de forma amable o insistente.',
                    'Genera confianza con atención, halagos o cercanía rápida.',
            ...
            explanation: 'El grooming avanza en fases: contacto, confianza, privacidad y presión. El problema no empieza cuando aparece una amenaza, sino desde que alguien empieza a aislar o presionar al menor.',
            points: 8,
        },
        {
            text: 'Selecciona las tres señales que el módulo identifica como indicadores de grooming o contacto manipulador.',
            type: 'multiple_selection',
            options: [
                { text: 'La persona pide guardar la conversación en secreto y no contarla a nadie', isCorrect: true },
                { text: 'La persona insiste en seguir la charla por otra app más privada', isCorrect: true },
                { text: 'El menor se pone nervioso si un adulto ve ciertos mensajes suyos', isCorrect: true },
                { text: 'El menor activa la verificación de dos pasos en su cuenta', isCorrect: false },
                { text: 'El menor le cuenta a su padre con quién habla en Discord', isCorrect: false },
            ],
            explanation: 'Pedir secreto, mover la conversación y nerviosismo ante adultos que ven mensajes son señales concretas de manipulación. Activar verificación de dos pasos es una acción de seguridad positiva, no una señal de riesgo. Contarle al padre es una conducta sana.',
            points: 10,
        },
        {
            text: 'Elige la opción correcta para completar cada oración sobre grooming y contacto de riesgo.',
            type: 'drop_down',
            metadata: {
                sentence: 'El grooming no suele empezar con contenido [blank1], sino con atención y cercanía que bajan la guardia del menor. Cuando alguien pide guardar [blank2], eso ya es una señal seria aunque la conversación parezca normal. Si insiste en pasar a otra [blank3], el riesgo aumenta. Las barreras de las plataformas ayudan, pero no sustituyen la [blank4] con el menor. La regla más útil que puede enseñar un padre es: si algo te incomoda, sal y [blank5].',
                options: {
                    blank1: ['sexual', 'escolar', 'deportivo'],
                    blank2: ['secretos', 'canciones', 'tareas'],
                    blank3: ['app', 'habitación', 'clase'],
                    blank4: ['conversación', 'pantalla', 'contraseña'],
                    blank5: ['avísame', 'ignóralo', 'respóndele'],
                },
                correctAnswer: {
                    blank1: 'sexual',
                    blank2: 'secretos',
            ...
            explanation: 'El grooming empieza con cercanía, no con contenido sexual. El secreto es la primera señal. Mover la conversación sube el riesgo. La conversación con el menor es la mejor herramienta. Y la regla simple más útil es: sal y avísame.',
            points: 10,
        },
        {
            text: 'Asigna cada situación a la categoría correcta según el módulo.',
            type: 'categorize',
            metadata: {
                items: [
                    'Le piden que no le cuente a nadie la conversación',
                    'Le piden fotos o videos como prueba de que confía en la persona',
                    'La persona busca hablar solo con él y alejarlo de sus amigos del grupo',
                    'Un seguidor desconocido comenta insistentemente sus publicaciones',
                    'Recibe solicitudes de mensaje de cuentas que no conoce en Instagram',
                    'Entra a un servidor abierto de Discord donde hay personas que no conoce',
                    'Guardar capturas de los mensajes antes de bloquear',
                    'Revisar quién puede enviar mensajes directos en cada plataforma',
                    'Decirle al menor: si algo te incomoda, sales y me avisas',
                ],
                categories: ['Señal de manipulación', 'Contacto de riesgo', 'Acción del padre'],
                correctAnswer: {
            ...
            explanation: 'El módulo distingue tres planos: cómo empieza el contacto de riesgo, cuándo se vuelve manipulador, y qué acciones concretas puede tomar el padre para proteger al menor.',
            points: 15,
        },
        {
            text: 'Caso: Un preadolescente le cuenta a su madre que alguien en Discord siempre está disponible cuando quiere hablar, le dice que por fin alguien lo entiende de verdad, le pide que no le cuente nada a sus padres y ahora quiere seguir la charla por WhatsApp. ¿Qué debe hacer la madre según el módulo?',
            type: 'case_study',
            options: [
                { text: 'Tomarlo en serio porque hay tres señales claras de manipulación: cercanía rápida, petición de secreto y cambio a otra app. Debe guardar evidencia, bloquear al contacto, reportarlo y reforzar que hizo bien en contarlo.', isCorrect: true },
                { text: 'Esperar a ver si la persona le pide algo concreto antes de preocuparse, porque por ahora solo han hablado.', isCorrect: false },
                { text: 'Quitarle el Discord sin escuchar más, porque eso resolverá el problema por completo.', isCorrect: false },
                { text: 'Asumir que si el menor se siente bien con esa persona, la relación no puede ser peligrosa.', isCorrect: false },
            ],
            explanation: 'Cercanía muy rápida, petición de secreto y presión para cambiar de plataforma son tres señales juntas del patrón de grooming. No hay que esperar a que llegue una amenaza explícita para actuar.',
            points: 15,
        },
    ];
    ...
    const module5QuizQuestions = [
        {
            ...
            metadata: {
                pairs: [
                    { key: 'Exposición accidental', value: 'Encontrarse con contenido inapropiado sin haberlo buscado, por recomendaciones o material compartido por otros' },
                    { key: 'Contenido sensible', value: 'Material violento, sexualizado o perturbador que no es adecuado para la edad del menor' },
                    { key: 'Reto viral', value: 'Contenido que invita al menor a imitar una conducta, grabarla y compartirla para no quedarse fuera' },
                    { key: 'Desinformación', value: 'Contenido falso o engañoso que se comparte sin verificar porque provoca una emoción rápida' },
                    { key: 'Fuente', value: 'Persona, cuenta o lugar desde donde sale originalmente un contenido o una afirmación' },
                ],
                correctAnswer: {
                    'Exposición accidental': 'Encontrarse con contenido inapropiado sin haberlo buscado, por recomendaciones o material compartido por otros',
                    'Contenido sensible': 'Material violento, sexualizado o perturbador que no es adecuado para la edad del menor',
                    'Reto viral': 'Contenido que invita al menor a imitar una conducta, grabarla y compartirla para no quedarse fuera',
                    'Desinformación': 'Contenido falso o engañoso que se comparte sin verificar porque provoca una emoción rápida',
                    'Fuente': 'Persona, cuenta o lugar desde donde sale originalmente un contenido o una afirmación',
                },
            },
            explanation: 'El módulo diferencia entre encontrarse algo sin buscarlo (exposición accidental) y decidir compartir algo impactante sin verificarlo (desinformación). Los retos virales combinan ambos riesgos.',
            points: 12,
        },
        {
            text: 'Completa cada oración con la palabra correcta del banco.',
            type: 'fill_blanks',
            metadata: {
                sentence: 'En TikTok el contenido problemático puede aparecer por [blank1] que llevan de un video normal a uno cada vez más perturbador. En Instagram puede llegar por reels, la sección Explorar o perfiles [blank2]. En Discord suele entrar por mensajes, archivos y canales dentro de [blank3]. Los rumores y retos se propagan rápido porque provocan emociones [blank4] como miedo o urgencia. Ver algo en muchos lugares no significa que sea [blank5].',
                bank: ['cadenas', 'sugeridos', 'servidores', 'rápidas', 'verdadero'],
                correctAnswer: {
                    blank1: 'cadenas',
                    blank2: 'sugeridos',
                    blank3: 'servidores',
            ...
            explanation: 'TikTok = cadenas de videos. Instagram = perfiles sugeridos y Explorar. Discord = servidores y archivos. La desinformación viaja por emociones rápidas. Repetición no es igual a verdad.',
            points: 12,
        },
        {
            text: 'Clasifica cada situación según la plataforma donde ocurre según el módulo.',
            ...
            metadata: {
                left: ['TikTok', 'Discord', 'Instagram'],
                right: [
                    'El For You Page lleva al menor de videos normales a contenido inapropiado sin que lo busque',
                    'TikTok tiene Restricted Mode para reducir contenido no adecuado',
                    'Un canal de un servidor comparte imágenes sensibles entre sus miembros',
                    'Un miembro del servidor comparte archivos con contenido inapropiado en un canal de texto privado',
                    'La sección Explorar muestra reels con contenido violento o sexualizado',
                    'Instagram tiene configuraciones más protectoras para cuentas de adolescentes',
                ],
                correctAnswer: {
                    TikTok: [
                        'El For You Page lleva al menor de videos normales a contenido inapropiado sin que lo busque',
            ...
            explanation: 'TikTok expone por cadenas de videos y tiene Restricted Mode. Discord expone por archivos y mensajes en servidores. Instagram expone por la sección Explorar y reels sugeridos.',
            points: 12,
        },
        {
            text: 'Ordena cómo un rumor o reto viral puede extenderse hasta que el menor lo cree o participa.',
            type: 'order_sequence',
            metadata: {
                items: [
                    'Aparece un contenido llamativo, urgente o sorprendente.',
                    'El menor reacciona emocionalmente de forma muy rápida.',
                    'Lo ve repetido en varias apps o conversaciones.',
                    'Siente ganas de compartirlo o participar para no quedarse fuera.',
                    'El contenido sigue circulando aunque no sea verdadero ni seguro.',
                ],
                correctAnswer: [
                    'Aparece un contenido llamativo, urgente o sorprendente.',
                    'El menor reacciona emocionalmente de forma muy rápida.',
            ...
            explanation: 'La viralidad funciona por impacto emocional, repetición y presión de grupo. Cuando el menor lo ve en muchos sitios, lo siente más real aunque nadie lo haya verificado.',
            points: 8,
        },
        {
            text: 'Selecciona las tres señales que el módulo relaciona con exposición a contenido inapropiado o desinformación.',
            type: 'multiple_selection',
            options: [
                { text: 'Se altera o se pone ansioso justo después de usar cierta app', isCorrect: true },
                { text: 'Empieza a repetir lenguaje o temas muy adultos que no aprendió en casa', isCorrect: true },
                { text: 'Siente urgencia de hacer un reto sin saber bien de qué se trata ni si es seguro', isCorrect: true },
                { text: 'Baja el brillo del teléfono para no molestar a sus hermanos por la noche', isCorrect: false },
                { text: 'Antes de reenviar un video, pregunta de dónde viene y quién lo hizo', isCorrect: false },
            ],
            explanation: 'Alterarse con la app, repetir lenguaje adulto y participar en retos por urgencia son señales de alerta reales. Bajar el brillo es un comportamiento neutral. Preguntar la fuente antes de compartir es un hábito saludable, no una señal de problema.',
            points: 10,
        },
        {
            text: 'Elige la opción correcta para completar cada oración sobre contenido viral y desinformación.',
            type: 'drop_down',
            metadata: {
                sentence: 'Un reto viral no solo invita al menor a mirar, sino también a [blank1] y compartirlo. Cuando algo provoca mucho miedo o urgencia, conviene hacer una [blank2] antes de creerlo o compartirlo. Ver algo repetido en varias apps puede dar una falsa sensación de que ya fue [blank3]. Los padres pueden ayudar preguntando quién publicó el contenido y cuál era su [blank4]. Que algo sea muy popular no significa que sea [blank5].',
                options: {
                    blank1: ['imitarlo', 'ignorarlo', 'guardarlo en favoritos'],
                    blank2: ['pausa', 'captura', 'llamada de emergencia'],
                    blank3: ['verificado', 'olvidado', 'borrado'],
                    blank4: ['intención', 'idioma', 'velocidad'],
                    blank5: ['verdadero', 'peligroso', 'aburrido'],
                },
                correctAnswer: {
                    blank1: 'imitarlo',
                    blank2: 'pausa',
            ...
            explanation: 'Los retos invitan a imitar. La pausa ayuda a pensar antes de creer. La repetición no es verificación. Preguntar la intención ayuda a evaluar el contenido. Popular no significa verdadero.',
            points: 10,
        },
        {
            text: 'Asigna cada situación a la categoría correcta según el módulo.',
            ...
            metadata: {
                items: [
                    'El feed de TikTok lleva al menor de un video normal a uno perturbador sin que lo busque',
                    'En Discord le mandan archivos con imágenes inapropiadas por mensaje directo',
                    'La sección Explorar de Instagram le muestra contenido sensible entre las recomendaciones',
                    'Comparte un rumor porque lo vio en TikTok, Discord e Instagram y le pareció real',
                    'Siente presión de hacer un reto viral porque siente que todos lo están haciendo',
                    'Comparte una "noticia urgente" sin verificar quién la publicó ni si es verdad',
                    'Activar Restricted Mode en TikTok para reducir contenido no adecuado',
                    'Preguntar al menor: ¿quién publicó eso y para qué lo hizo?',
                    'Recordarle que ver algo repetido en varias apps no significa que sea verdadero',
                ],
                categories: ['Exposición accidental', 'Viralidad y desinformación', 'Respuesta del padre'],
                correctAnswer: {
                    'Exposición accidental': [
                        'El feed de TikTok lleva al menor de un video normal a uno perturbador sin que lo busque',
                        'En Discord le mandan archivos con imágenes inapropiadas por mensaje directo',
            ...
            explanation: 'El módulo trabaja tres planos equilibrados: cómo llega el contenido sin buscarlo, por qué se comparte sin verificar, y qué puede hacer el padre para acompañar con criterio.',
            points: 15,
        },
        {
            text: 'Caso: Un menor ve en TikTok videos sobre un reto que parece inofensivo, lo encuentra también en Discord y en Instagram, y decide hacerlo porque siente que si no participa se queda fuera. Antes de grabarse, le cuenta a su padre. ¿Cuál es la respuesta más alineada con el módulo?',
            type: 'case_study',
            options: [
                { text: 'Hacer una pausa, revisar juntos quién creó el reto y cuál es su intención, hablar de que verlo en muchos sitios no lo hace seguro ni verdadero, y valorar si participar tiene algún riesgo real.', isCorrect: true },
                { text: 'Decirle que si lo vio en tres plataformas distintas ya fue verificado y puede hacerlo sin preocuparse.', isCorrect: false },
                { text: 'Quitarle todas las apps sin explicarle por qué ese reto era un problema ni cómo identificar uno parecido en el futuro.', isCorrect: false },
                { text: 'Asumir que como el reto parece divertido y muchos lo hacen, no puede ser peligroso.', isCorrect: false },
            ],
            explanation: 'El módulo enseña que la repetición en varias plataformas no es verificación. Antes de imitar un reto conviene pausar, revisar la fuente e intención, y valorar el riesgo real aunque parezca inofensivo.',
            points: 15,
        },
    ];
    ...
    const module6QuizQuestions = [
        {
            ...
            metadata: {
                pairs: [
                    { key: 'Publicidad disfrazada', value: 'Promoción que se mezcla con el entretenimiento y parece una recomendación espontánea del creador' },
                    { key: 'Paid partnership', value: 'Etiqueta en Instagram que indica que hay una relación comercial entre el creador y una marca' },
                    { key: 'Coins o Stars', value: 'Monedas o saldos virtuales dentro de la app que representan dinero real' },
                    { key: 'Nitro (Discord)', value: 'Suscripción de pago de Discord que da ventajas y puede regalarse, mezclando gasto con amistad' },
                    { key: 'Compra impulsiva', value: 'Gasto rápido y emocional que no se percibe como una compra porque se siente como apoyo o participación' },
                ],
                correctAnswer: {
                    'Publicidad disfrazada': 'Promoción que se mezcla con el entretenimiento y parece una recomendación espontánea del creador',
                    'Paid partnership': 'Etiqueta en Instagram que indica que hay una relación comercial entre el creador y una marca',
                    'Coins o Stars': 'Monedas o saldos virtuales dentro de la app que representan dinero real',
                    'Nitro (Discord)': 'Suscripción de pago de Discord que da ventajas y puede regalarse, mezclando gasto con amistad',
                    'Compra impulsiva': 'Gasto rápido y emocional que no se percibe como una compra porque se siente como apoyo o participación',
                },
            },
            explanation: 'El módulo distingue dos tipos de riesgo: la publicidad disfrazada que influye sin parecer venta, y las monedas y regalos digitales que hacen que el gasto se sienta como participación social.',
            points: 12,
        },
        {
            text: 'Completa cada oración con la palabra correcta del banco.',
            type: 'fill_blanks',
            metadata: {
                sentence: 'En TikTok la promoción puede parecer una recomendación espontánea de un [blank1] aunque haya un acuerdo comercial detrás. En Instagram, la etiqueta [blank2] indica que hay una relación entre el creador y una marca. En Discord, regalar [blank3] puede sentirse como un gesto de amistad aunque implique dinero real. Coins, Stars y Nitro son formas de [blank4] dentro de las plataformas. Si ya hay una tarjeta [blank5] en el dispositivo, el riesgo de gasto impulsivo aumenta.',
                bank: ['creador', 'Paid partnership', 'Nitro', 'gastar', 'guardada'],
                correctAnswer: {
                    blank1: 'creador',
            ...
            explanation: 'Creador, Paid partnership, Nitro, gastar y tarjeta guardada son los cinco conceptos clave del módulo 6.',
            points: 12,
        },
        {
            text: 'Clasifica cada situación según la plataforma a la que pertenece.',
            type: 'match_columns',
            metadata: {
                left: ['TikTok', 'Instagram', 'Discord'],
                right: [
                    'Un creador usa la etiqueta "Promotional content" en un video para revelar que es publicidad',
                    'El menor puede recargar Coins y enviar Gifts a creadores en directos o videos',
                    'Una publicación tiene la etiqueta "Paid partnership" junto al nombre del creador',
                    'Stars y Gifts permiten apoyar económicamente a creadores en Reels o contenido en vivo',
                    'Regalar Nitro a un amigo puede sentirse como un gesto de amistad aunque implique dinero',
                    'Nitro y Nitro Basic son suscripciones de pago que dan ventajas dentro de la comunidad',
                ],
                correctAnswer: {
                    TikTok: [
                        'Un creador usa la etiqueta "Promotional content" en un video para revelar que es publicidad',
            ...
            explanation: 'TikTok usa "Promotional content" y Coins/Gifts. Instagram usa "Paid partnership" y Stars/Gifts. Discord usa Nitro y suscripciones de pago. Cada plataforma tiene sus propios mecanismos.',
            points: 12,
        },
        {
            text: 'Ordena cómo puede ocurrir un gasto impulsivo dentro de una plataforma según el módulo.',
            type: 'order_sequence',
            metadata: {
                items: [
                    'El menor ve una función que promete apoyar, reaccionar o participar más.',
                    'La plataforma presenta el gasto como Coins, Stars, Gifts o Nitro.',
                    'La acción se siente social o emocional, no como una compra real.',
                    'Si ya hay un método de pago guardado, la barrera para gastar baja mucho.',
                    'El gasto ocurre sin darse cuenta de que equivale a dinero real.',
                ],
                correctAnswer: [
                    'El menor ve una función que promete apoyar, reaccionar o participar más.',
                    'La plataforma presenta el gasto como Coins, Stars, Gifts o Nitro.',
            ...
            explanation: 'El diseño del gasto digital lo hace parecer participación o apoyo, no una compra. Tener un método de pago ya guardado elimina la fricción que normalmente haría pensar antes de gastar.',
            points: 8,
        },
        {
            text: 'Selecciona las tres situaciones que el módulo identifica como señales de influencia comercial o gasto impulsivo.',
            type: 'multiple_selection',
            options: [
                { text: 'Cree que un influencer recomienda una marca porque le gusta, sin fijarse si hay una etiqueta comercial', isCorrect: true },
                { text: 'Quiere mandar Stars a un creador porque siente que así lo apoyará de verdad', isCorrect: true },
                { text: 'Pide acceso a la tarjeta guardada "solo para regalar Nitro a un amigo"', isCorrect: true },
                { text: 'Antes de seguir un creador, busca saber quién patrocina su contenido', isCorrect: false },
                { text: 'Guarda una canción en favoritos dentro de una app de música', isCorrect: false },
            ],
            explanation: 'No distinguir publicidad de recomendación, ver Stars como apoyo emocional y pedir acceso al pago para "algo pequeño" son señales del módulo. Buscar quién patrocina al creador es un hábito crítico positivo. Guardar canciones es irrelevante.',
            points: 10,
        },
        {
            text: 'Elige la opción correcta para completar cada oración sobre publicidad y gasto en plataformas.',
            type: 'drop_down',
            metadata: {
                sentence: 'Que un creador parezca cercano no significa que su recomendación sea [blank1]. La etiqueta [blank2] ayuda a identificar contenido comercial en Instagram. Coins, Stars y Nitro son formas de gastar que pueden no sentirse como [blank3] real. Si ya hay una tarjeta [blank4] en la app, el riesgo de compra impulsiva aumenta mucho. Para acompañar bien, los padres pueden preguntar si el creador lo muestra porque le gusta o porque le [blank5].',
                options: {
                    blank1: ['neutral', 'obligatoria', 'gratis'],
                    blank2: ['Paid partnership', 'Modo avión', 'Restricted Mode'],
                    blank3: ['dinero', 'tiempo', 'batería'],
                    blank4: ['guardada', 'apagada', 'vacía'],
                    blank5: ['pagan', 'preguntan', 'prohíben'],
                },
                correctAnswer: {
                    blank1: 'neutral',
                    blank2: 'Paid partnership',
            ...
            explanation: 'Recomendación neutral, Paid partnership, dinero real, tarjeta guardada y pregunta sobre si le pagan son los cinco puntos de acción del módulo 6.',
            points: 10,
        },
        {
            text: 'Asigna cada situación a la categoría correcta.',
            type: 'categorize',
            metadata: {
                items: [
                    'Un video de TikTok tiene la etiqueta "Promotional content"',
                    'Un reel de Instagram muestra una marca con la etiqueta "Paid partnership"',
                    'Un creador recomienda un producto con mucho entusiasmo sin ninguna etiqueta visible',
                    'El menor quiere recargar Coins para que un creador lo note en un directo',
                    'Cree que regalar Nitro es solo un gesto social, no una compra real',
                    'Pide acceso al método de pago para "solo una cosa pequeña"',
                    'Preguntar: ¿lo muestra porque le gusta o porque le pagan?',
                    'Explicar que Coins, Stars y Nitro equivalen a dinero real',
                    'Revisar si hay tarjetas guardadas en la app o en el dispositivo',
                ],
                categories: ['Señal de publicidad comercial', 'Señal de gasto impulsivo', 'Respuesta del padre'],
                correctAnswer: {
            ...
            explanation: 'El módulo trabaja tres planos: cómo reconocer publicidad comercial, cómo se oculta el gasto digital, y qué puede hacer el padre para acompañar con criterio.',
            points: 15,
        },
        {
            text: 'Caso: Un menor quiere mandar Stars a un creador de Instagram porque "le da gusto apoyarlo", también quiere recargar Coins en TikTok para que un streamer lo note, y además le pide a su padre la tarjeta "solo para regalar Nitro a un amigo". ¿Cuál es la respuesta más alineada con el módulo?',
            type: 'case_study',
            options: [
                { text: 'Explicar que Stars, Coins y Nitro representan dinero real aunque se sientan como gestos sociales, revisar si hay métodos de pago guardados y hablar de que apoyar a alguien no requiere gastar dinero.', isCorrect: true },
                { text: 'Permitir el gasto porque son cantidades pequeñas y digitales, que no cuentan igual que una compra real.', isCorrect: false },
                { text: 'Quitarle todas las apps sin explicarle la diferencia entre publicidad, influencia y gasto impulsivo.', isCorrect: false },
                { text: 'Decirle que solo hay riesgo si gasta mucho dinero de una vez, no en gestos pequeños y frecuentes.', isCorrect: false },
            ],
            explanation: 'El módulo enseña que Stars, Coins y Nitro son dinero real aunque parezcan gestos sociales. El riesgo aumenta cuando ya hay un método de pago guardado. Apoyar puede hacerse sin gastar.',
            points: 15,
        },
    ];
    ...
    const module7QuizQuestions = [
        {
            text: 'Relaciona cada herramienta con la plataforma a la que pertenece y lo que hace.',
            type: 'drag_drop',
            metadata: {
                pairs: [
            ...
            explanation: 'Family Pairing = TikTok. Teen Accounts = Instagram. Family Center = Discord. Acompañar y vigilar en exceso no son lo mismo ni tienen el mismo efecto en la confianza del menor.',
            points: 12,
        },
        {
            text: 'Completa cada oración con la palabra correcta del banco.',
            ...
            explanation: 'TikTok = tiempo. Instagram = Teen Accounts. Discord = mensajes. Los controles necesitan conversación. Sin confianza, el menor aprende a ocultar.',
            points: 12,
        },
        {
            text: 'Clasifica cada herramienta o ajuste según la plataforma a la que pertenece.',
            type: 'match_columns',
            metadata: {
                left: ['TikTok', 'Instagram', 'Discord'],
                right: [
                    'Family Pairing para vincular cuenta del adulto y gestionar tiempo e interacciones',
        ...
        {
            text: 'Ordena los pasos de un acompañamiento digital sano según el módulo.',
            type: 'order_sequence',
            metadata: {
                items: [
                    'Conocer qué plataformas usa el menor y para qué las usa.',
                    'Activar o revisar juntos los ajustes de seguridad más útiles en cada app.',
                    'Explicar al menor para qué sirven los límites y filtros activados.',
                    'Acordar reglas y rutinas digitales claras con toda la familia.',
                    'Mantener conversaciones frecuentes y ajustar las reglas según edad y madurez.',
                ],
                correctAnswer: [
                    'Conocer qué plataformas usa el menor y para qué las usa.',
                    'Activar o revisar juntos los ajustes de seguridad más útiles en cada app.',
            ...
            explanation: 'El acompañamiento sano empieza con entender, luego configura, explica, acuerda y revisa. No empieza con vigilar ni termina en castigar.',
            points: 8,
        },
        {
            text: 'Selecciona las cuatro acciones que el módulo presenta como formas de acompañar sin invadir.',
            type: 'multiple_selection',
            options: [
                { text: 'Revisar juntos privacidad, mensajes y tiempo de uso de cada app', isCorrect: true },
                { text: 'Explicar al menor para qué sirve cada límite activado', isCorrect: true },
                { text: 'Acordar momentos regulares para hablar de lo que pasa en línea', isCorrect: true },
                { text: 'Ajustar los controles conforme cambia la edad y madurez del menor', isCorrect: true },
                { text: 'Revisar todos los mensajes a escondidas para no perder información', isCorrect: false },
                { text: 'Aplicar las mismas reglas sin cambiarlas nunca, sin importar la edad', isCorrect: false },
            ],
            explanation: 'Revisar juntos, explicar razones, hablar regularmente y ajustar según la edad son las cuatro acciones del acompañamiento sano. Revisar a escondidas y no cambiar nunca las reglas son ejemplos de vigilancia excesiva.',
            points: 10,
        },
        {
            text: 'Elige la opción correcta para completar cada oración sobre controles y acompañamiento.',
            type: 'drop_down',
            metadata: {
                sentence: 'Supervisar bien no significa saberlo [blank1]. Cuando el adulto explica reglas y conversa, el menor tiene más probabilidades de [blank2] si algo le pasa. Los controles parentales funcionan como [blank3], no como solución única. Revisar todo sin avisar se parece más a [blank4] que a acompañar. Las reglas digitales se aprenden mejor con [blank5] y con práctica cotidiana.',
                options: {
                    blank1: ['todo', 'menos', 'más tarde'],
                    blank2: ['contar lo que le pasa', 'borrar sus apps', 'usar más tiempo'],
                    blank3: ['apoyo', 'castigo', 'pantalla extra'],
                    blank4: ['vigilar en exceso', 'jugar en familia', 'organizar rutinas'],
                    blank5: ['ejemplo', 'silencio', 'más restricciones'],
                },
                correctAnswer: {
                    blank1: 'todo',
            ...
            explanation: 'No hay que saberlo todo. La conversación genera confianza. Los controles son apoyo, no solución única. Revisar a escondidas es vigilar en exceso. El ejemplo del adulto enseña más que las restricciones.',
            points: 10,
        },
        {
            text: 'Asigna cada acción a la categoría correcta según el módulo.',
            type: 'categorize',
            metadata: {
                items: [
                    'Preguntar qué le gusta de una app y para qué la usa',
                    'Revisar toda la actividad a escondidas sin que el menor lo sepa',
                    'Revisar configuraciones de privacidad y mensajes junto al menor',
                    'Imponer reglas sin explicar ningún motivo',
                    'Ajustar los límites conforme el menor crece y madura',
                    'Aparecer únicamente cuando hay un problema para castigar',
                    'Explicar al menor por qué existe cada regla digital',
                    'Aplicar el mismo control siempre sin adaptarlo a la plataforma ni a la edad',
                ],
            ...
            explanation: 'Acompañar implica presencia, explicación y adaptación. Vigilar en exceso implica secreto, rigidez y reacción solo ante problemas. La diferencia afecta directamente la confianza del menor.',
            points: 15,
        },
        {
            text: 'Caso: Una madre activó Family Pairing en TikTok, Teen Accounts en Instagram y Family Center en Discord, pero nunca explicó para qué sirven. Cuando su hijo pregunta por qué tiene esas restricciones, ella responde que "es para protegerlo" sin dar más detalles. Además, revisa su teléfono cuando él no está. ¿Qué le falta hacer según el módulo?',
            type: 'case_study',
            options: [
                { text: 'Explicarle al hijo para qué sirve cada herramienta, revisar ajustes juntos, dejar de revisar a escondidas y dejar claro que puede pedir ayuda sin que eso traiga castigo automático.', isCorrect: true },
                { text: 'Mantener la revisión secreta porque lo importante es enterarse de todo para protegerlo mejor.', isCorrect: false },
                { text: 'Quitar todos los controles para que el hijo no sienta que lo vigilan.', isCorrect: false },
                { text: 'Aplicar exactamente los mismos ajustes por varios años sin cambiarlos nunca.', isCorrect: false },
            ],
            explanation: 'Los controles técnicos no bastan solos. El módulo enseña que su valor crece cuando se combinan con explicación, transparencia y una relación de confianza donde el menor sepa que puede pedir ayuda.',
            points: 15,
        },
    ];
    ...
    const finalQuizQuestions = [
        ...
        },
        {
            ...
            type: 'multiple_selection',
            options: [
                { text: 'Preguntar quién hizo el contenido y con qué intención', isCorrect: true },
                { text: 'Preguntar si el contenido quiere informar, entretener o vender', isCorrect: true },
                { text: 'Recordar que popular no significa verdadero ni sincero', isCorrect: true },
                { text: 'Revisar todo a escondidas para enterarse de más sin hablar con el menor', isCorrect: false },
                { text: 'Asumir que una cuenta privada elimina cualquier riesgo', isCorrect: false },
                { text: 'Pensar que una etiqueta de patrocinado siempre basta para que el menor entienda', isCorrect: false }
            ],
        ...
        },
        {
            ...
            options: [
                ...
                { text: 'Habla abiertamente de lo que ve y comparte en sus apps', isCorrect: false },
                { text: 'Pide permiso al adulto antes de publicar fotos o videos', isCorrect: false },
                { text: 'Le gusta personalizar el fondo de su perfil de redes sociales', isCorrect: false }
            ],
