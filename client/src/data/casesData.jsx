...
export const casesData = [
    {
        ...
        lessons: 'La rapidez de la intervención es clave. Los padres de Amanda no solo hablaron con ella, sino que recolectaron evidencia digital antes de que el contenido fuera borrado, lo que permitió a la policía cibernética rastrear el origen.',
        riskLevel: 'Crítico',
        timeline: [
        ...
        color: 'red',
        tips: [
            'Guarda evidencia con capturas de pantalla.',
    ...
    },
    {
        ...
        fullContent: "Julián vio un video en YouTube donde un 'influencer' regalaba Robux. El enlace lo llevó a una página que se veía idéntica a la oficial de Roblox. Al poner su usuario y contraseña, un script robó su sesión. Como la tarjeta seguía vinculada por una compra anterior, los estafadores compraron ítems por un valor de $2,500 MXN en cuestión de minutos.",
        lessons: "Nunca se deben guardar datos de pago de forma permanente en cuentas usadas por menores. La educación sobre phishing es necesaria desde que empiezan a jugar en línea.",
        riskLevel: 'Alto',
        timeline: [
            ...
            { time: '14:15', event: 'El banco detecta la primera transacción no autorizada.' },
    ...
    },
    {
        ...
        fullContent: "El acosador pasó 3 meses 'jugando' con Mateo. Le regalaba skins y pases de batalla para ganarse su lealtad. Eventualmente, la conversación se movió a Discord, donde empezó a pedirle que encendiera la cámara cuando los padres no estaban presentes.",
        lessons: 'El regalo es una de las tácticas más comunes. Si alguien que no conoces en la vida real empieza a darte cosas de valor, eso es una alerta roja inmediata. El diálogo abierto con sus padres salvó a Mateo de una situación más grave.',
        riskLevel: 'Muy alto',
        timeline: [
            { time: 'Mes 1', event: 'Primer contacto en el lobby de Fortnite. Comienzan a jugar diario.' },
            { time: 'Mes 2', event: 'Mueven la conversación a Discord. El acosador da los primeros regalos.' },
            { time: 'Mes 3', event: 'Pide fotos y videollamadas privadas. Mateo se siente incómodo.' },
